...
export const signUpSuccess = withMatcher((user: User, additonalDetails: AdditionalInformation)  => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, additonalDetails }));
