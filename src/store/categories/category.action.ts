...
export type FetchCategoriesFaiiled = ActionWithPayload<CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_FAILED, Error>;
...
export const fetchCategoriesFaiiled = withMatcher((error: Error): FetchCategoriesFaiiled => createAction(CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_FAILED, error));
